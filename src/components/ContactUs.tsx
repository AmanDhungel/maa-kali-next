...
import {  MailCheckIcon, MapPin, PhoneCall } from 'lucide-react'
        ...
        <div className="mt-6 max-w-6xl max-lg:max-w-3xl mx-auto  rounded-lg">
            <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
                <div>
                    ...
                    <p className="text-md mt-4 leading-relaxed">Want suggestions on how to save resources while buidling your house! Visit us or contact us.</p>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
              <Textarea {...field}  placeholder='Your Questions / Suggestion / Message'/>
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
