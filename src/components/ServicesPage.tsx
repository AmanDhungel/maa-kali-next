...
const ServicesPage = () => {
  return (
    ...
    <h2 className="mb-1 text-3xl font-extrabold leading-tight text-gray-900 dark:text-white">Services</h2>
    <p className="mb-12 text-lg text-gray-500">Here is a few of the awesome Services & Products we provide.</p>
    <div className="w-full">
        <div className="flex flex-col w-full mb-10 sm:flex-row">
            <div className="w-full mb-10 sm:mb-0 sm:w-1/2">
                <div className="relative h-full ml-0 mr-0 sm:mr-10">
                    <span className="absolute top-0 left-0 w-full h-full mt-1 ml-1 bg-indigo-500 rounded-lg"></span>
                    <div className="relative h-full p-5 bg-black dark:bg-white border-2 border-indigo-500 rounded-lg">
            ...
            <div className="w-full sm:w-1/2">
                <div className="relative h-full ml-0 md:mr-10">
                    ...
                    <div className="relative h-full p-5 bg-black dark:bg-white border-2 border-purple-500 rounded-lg">
                        <div className="flex items-center -mt-1">
        ...
        <div className="flex flex-col w-full mb-5 sm:flex-row">
            <div className="w-full mb-10 sm:mb-0 sm:w-1/2">
                <div className="relative h-full ml-0 mr-0 sm:mr-10">
                    ...
                    <div className="relative h-full p-5 bg-black dark:bg-white border-2 border-blue-400 rounded-lg">
                        <div className="flex items-center -mt-1">
            ...
            <div className="w-full mb-10 sm:mb-0 sm:w-1/2">
                <div className="relative h-full ml-0 mr-0 sm:mr-10">
                    ...
                    <div className="relative h-full p-5 bg-black dark:bg-white border-2 border-yellow-400 rounded-lg">
                        <div className="flex items-center -mt-1">
                            <h3 className="flex justify-between w-full my-2 ml-3 text-lg font-bold text-white dark:text-gray-800">Comode & Tiles<Image src="https://images.pexels.com/photos/8143713/pexels-photo-8143713.jpeg?auto=compress&cs=tinysrgb&w=600" className='w-11 h-11 rounded-full' width={100} height={100} alt="image"/></h3>
                        </div>
            ...
            <div className="w-full sm:w-1/2">
                <div className="relative h-full ml-0 md:mr-10">
                    ...
                    <div className="relative h-full p-5 bg-black dark:bg-white border-2 border-green-500 rounded-lg">
                        <div className="flex items-center -mt-1">
                            <h3 className="flex justify-between w-full my-2 ml-3 text-lg font-bold text-white dark:text-gray-800">Bot/Script Development <Image src="https://images.pexels.com/photos/8143713/pexels-photo-8143713.jpeg?auto=compress&cs=tinysrgb&w=600" className='w-11 h-11 rounded-full' width={100} height={100} alt="image"/></h3>
                        </div>
